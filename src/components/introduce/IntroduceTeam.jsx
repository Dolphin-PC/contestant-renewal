      ...
      <div>
         <div className="inner10">
            <div style={{ marginTop: 50 }}>
               <Row>
                  <Col lg="6">
                     ...
                     <p>
                        소수로 구성된 여러 팀들은 다양한 공모전에 도전합니다. 수
                        많은 회의를 통해서 만들어낸 결과물을 통해서, 스펙은 덤!
            ...
            <Row style={{ marginTop: 20 }} className="Introduce">
               ...
               <Col lg="4">
                  <Paper elevation={3} style={PaperStyle}>
                     ...
                     <li>
                        공모자들과 함께 빠방한 공모전 수상 경험 쌓아서 마케팅,
                        기획, IT등 다양한 흥미분야에서 스펙을 쌓을 수 있습니다.
                     </li>
                  </Paper>
               </Col>
               <Col lg="4">
            ...
            <div style={{ marginTop: 50, textAlign: "center" }}>
               ...
               <h4>
                  우리 '공모자들'이 운영되고 힘써주시는 서포터즈 분들입니다!
               </h4>
               <hr />
               <Row>
                  <Col lg="3">
