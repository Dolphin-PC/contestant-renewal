    ...
    return (
      <div className={classes.root}>
        ...
        <TabPanel value={value} index={0}>
          <RuleTextFormatComp {...Rules.OpinionRule} key={0} />
        </TabPanel>
        <TabPanel value={value} index={1}>
          <RuleTextFormatComp {...Rules.CostRule} key={1} />
        </TabPanel>
        <TabPanel value={value} index={2}>
          <RuleTextFormatComp {...Rules.OperatingRule} key={2} />
        </TabPanel>
        <TabPanel value={value} index={3}>
          <RuleTextFormatComp {...Rules.ChattingRule} key={3} />
        </TabPanel>
      </div>
    );
  };
